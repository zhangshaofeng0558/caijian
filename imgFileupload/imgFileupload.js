~(function(win){
	var htmls = '<input type="file" class="imgFiles" style="display: none" accept="image/gif,image/jpeg,image/jpg,image/png,image/svg" multiple>'+
				'<div class="imgAll"><ul></ul></div>'+
				'<div class="header"><span class="imgClick"></span></div>';
	...
	ImgFileupload.prototype.init =function() {
		...
		this.dom.innerHTML = 
							'    <img src="img/login.gif" alt="" data-src="'+this.imgSrc +'" data-name="'+this.imgName+'" class="imsg">'+
							'    <i class="delImg">'+
							'        X'+
							'    </i>';
